...
async function loadData(force=false){
  try{
    ...
    STATE.data = json;
    // header values
    // show device's current date (guarantees 'today' is current)
...
function renderRaces(){
  ...
  // back button
  const backEl = document.getElementById('backToVenues');
