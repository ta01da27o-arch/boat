...
import datetime, json, time, sys, warnings
...
def fetch_race_program(venue_code):
    ...
    for rno in range(1, 13):
        ...
        program["races"].append({"no": rno,"name": race_name,"boats": boats,"players": players})
    return program
...
def main():
    ...
    for v in venues:
        all_data["program"][v] = fetch_race_program(v)
